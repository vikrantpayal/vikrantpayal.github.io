...
**Disbelief and normalcy bias come first.** The most common initial reaction is denial. People tend to interpret ambiguous danger signals as normal ("that's probably just engine noise," "the crew has it under control"). This is called normalcy bias: the brain resists updating its model of reality to something catastrophic because catastrophe is so far outside everyday experience. 
